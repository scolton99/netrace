...
public class WaveView extends View {
    ...
    private Rect waveBase = new Rect();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawWave(canvas, (int)(canvasHeight * 0.88), BACKGROUND_WAVELENGTH, this.backgroundWavePaint, this.backgroundWaveOffset);
        drawWave(canvas, (int)(canvasHeight * 0.95), FOREGROUND_WAVELENGTH, this.foregroundWavePaint, this.foregroundWaveOffset);
    }
    ...
    private void drawWave(Canvas canvas, int y, int wavelength, Paint paint, int offset) {
        ...
        for (int i = -1; i < cycles; i++) {
            ...
            this.wavePath.quadTo(start + quarterWavelength, y - eighthWaveLength, start + halfWavelength, y);
            this.wavePath.quadTo(start + 3 * quarterWavelength, y + eighthWaveLength, start + wavelength, y);
