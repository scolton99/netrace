...
public class MainFragment extends Fragment {
  ...
  private final ValueAnimator ipAnimator = ValueAnimator.ofFloat(0, 1, 0, 0, 0, 0, 0, 0);
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    this.ipAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      ...
      public void onAnimationUpdate(ValueAnimator animation) {
        int startColor = getResources().getColor(R.color.textGray);
        float fraction = animation.getAnimatedFraction();

        int newColor = ColorUtils.blendARGB(startColor, Color.WHITE, fraction);
  ...
  public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
    ...
    switch (requestCode) {
      case NETWORK_STATE_PERMISSION_REQUEST: {
        if (grantResults[0] == PackageManager.PERMISSION_GRANTED) this.getTelephonyInfo();
      }
      case FINE_LOCATION_PERMISSION_REQUEST: {
        if (grantResults[0] == PackageManager.PERMISSION_GRANTED) this.loadWifiInfo();
      }
    }
  }
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) this.ipAddress = savedInstanceState.getString("ipAddress");
  ...
  public void loadWifiInfo() {
    ...
    if (wifiManager == null || wifiManager.getConnectionInfo().getSSID().equals("<unknown ssid>")) {
      ...
      this.localIpView.setTextColor(
              getActivity().getResources().getColor(android.R.color.primary_text_dark));
  ...
  private void checkPermissions() {
    ...
    else this.loadWifiInfo();

    if (ActivityCompat.checkSelfPermission(parent, Manifest.permission.ACCESS_NETWORK_STATE) !=
        PackageManager.PERMISSION_GRANTED)
      requestPermissions(new String[]{Manifest.permission.ACCESS_NETWORK_STATE}, 1);
    else this.getTelephonyInfo();
  }
  ...
  private void getTelephonyInfo() {
    ...
    this.cellularIpView.setText(address.getHostAddress());
