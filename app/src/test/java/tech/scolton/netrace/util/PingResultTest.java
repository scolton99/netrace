...
public class PingResultTest {
    private static final String SUCCESSFUL_PING_1 = "PING google.com (172.217.5.110) 56(85) bytes of data.\n" +
            "64 bytes from sfo03s07-in-f14.1e100.net (172.217.5.110): icmp_seq=1 ttl=54 time=7.64ms\n" +
            "\n" +
            "--- google.com ping statistics ---\n" +
            "1 packets transmitted, 1 received, 0% packet loss, time 0ms\n" +
            "rtt min/avg/max/mdev = 7.648/7.648/7.648/0.000 ms\n";

    private static final String FAILED_PING_1 = "PING hku.hk (147.8.2.58) 56(84) bytes of data.\n" +
            "\n" +
